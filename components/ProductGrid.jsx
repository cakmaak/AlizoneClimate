...
export default function ProductGrid({ products, title = "Öne Çıkan Klima Modelleri", description = "Enerji verimli, sessiz ve yüksek performanslı split klima seçenekleri. Hemen inceleyin ve montaj planınızı yapalım." }) {
  return (
