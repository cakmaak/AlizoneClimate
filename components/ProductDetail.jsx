  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto mt-6 px-4 sm:px-6 md:px-8">
        <button
          onClick={() => router.back()}
          className="mb-4 inline-flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-primary transition"
        >
          ← Önceki sayfaya dön
        </button>
      </div>
      ...
      {/* Product Detail */}
      <div className="bg-white rounded-2xl shadow-soft p-4 sm:p-6 md:p-8 max-w-5xl mx-auto relative mt-2">
