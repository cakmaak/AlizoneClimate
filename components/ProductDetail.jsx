...
export default function ProductDetail({ product, onClose }) {
  ...
  const normalizedValues = {
    ...
    noiseIndoor: productWithDefaults.noise_indoor_db ??
      ...
      null,
    noiseOutdoor: productWithDefaults.noise_outdoor_db ??
    ...
    refrigerant: productWithDefaults.refrigerant?.type ||
      productWithDefaults.refrigerant ||
      productWithDefaults.other_features?.refrigerant ||
      "—",
    warranty: productWithDefaults.warranty ??
