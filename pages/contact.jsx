...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="w-full h-[260px] sm:h-[320px] md:h-[700px] overflow-hidden">
        <img
          src="https://res.cloudinary.com/diyibvvua/image/upload/v1766232591/sssss_krch9i.jpg"
      ...
      <main className="container py-16 space-y-16">
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Sorularınız, randevu talepleriniz veya destek ihtiyacınız için bizimle
        ...
        <section className="bg-white rounded-3xl shadow-soft p-10 grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-3">
            ...
            <h4 className="text-2xl font-bold text-slate-800">
              Montaj & Servis Randevusu
            </h4>
            <p className="text-slate-600">
              Aynı gün ücretsiz keşif, hızlı teslimat ve satış sonrası bakım için
            ...
            <div className="space-y-4 mt-6">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-slate-800">
                  Ahi evran mahallesi 225 cadde F blok no:61 Sincan/Ankara
                </p>
              </div>
            </div>
          </div>
