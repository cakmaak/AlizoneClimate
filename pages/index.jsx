...
export default function Home() {
  ...
  const activityAreas = [
    {
      title: "Klimalar",
      image: "https://res.cloudinary.com/diyibvvua/image/upload/v1766052267/A_cozy_indoor_scene_featuring_children_playing_in_a_living_room._The_focus_is_on_a_modern_split_air_conditioner_prominently_mounted_on_the_wall._The_room_is_bright_with_natural_light_and_the_children_are_engaged_i_omgds1.jpg",
      href: "/products"
    },
    {
      title: "Mobil Klimalar",
      image: "https://res.cloudinary.com/diyibvvua/image/upload/v1766047423/A_portable_air_conditioner_in_a_modern_living_room_showing_the_appliance_working_quietly_and_efficiently._The_room_is_bright_and_airy_with_green_plants_in_the_background._s3a3zl.jpg",
      href: "/mobile-products"
    },
    {
      title: "Multi Split Klima",
      image: "https://res.cloudinary.com/diyibvvua/image/upload/v1766047574/A_modern_multi_split_air_conditioning_system_installed_in_a_bright_open_plan_living_area._The_indoor_units_are_mounted_on_the_walls_showcasing_a_sleek_design_with_sunlight_streaming_through_large_windows_and_decor_m0zyww.jpg",
      href: "/products"
    },
    {
      title: "Isı Pompası",
      image: "https://res.cloudinary.com/diyibvvua/image/upload/v1766052360/%C4%B1s%C4%B1pompasiiii_dve5gm.jpg",
      href: "/products"
    }
  ];
      ...
      <main className="space-y-16">
        <section className="relative isolate min-h-screen w-full overflow-hidden bg-slate-900">
          ...
          <div className="relative z-10 flex h-full items-center justify-center px-6 py-24">
            <div className="text-center text-white space-y-5 max-w-4xl">
              <p className="text-sm uppercase tracking-[0.28em] text-emerald-200/90">Alizone</p>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight drop-shadow">
                Yaşam Alanınız İçin En İyi Klima Çözümleri
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-slate-100/90 max-w-2xl mx-auto">
                Enerji verimli, sessiz ve güvenilir klimalarla dört mevsim konfor. Ücretsiz keşif ve montaj desteğiyle yanınızdayız.
              </p>
        ...
        <section className="container py-16">
          <div className="text-center space-y-3 mb-12">
            <p className="text-sm uppercase tracking-[0.2em] text-primary">Faaliyet Alanlarımız</p>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800">Hizmetlerimiz</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                Yıllardır sektörde edindiğimiz tecrübe ve müşteri memnuniyeti odaklı hizmet anlayışımızla,
                yüzlerce projede başarıyla hizmet verdik. Konut, ofis, işyeri ve endüstriyel tesislerde
                gerçekleştirdiğimiz profesyonel klima montaj ve bakım hizmetlerimizle referanslarımız
                her geçen gün artmaktadır.
              </p>
              <p className="text-slate-600 leading-relaxed">
                Enerji verimli sistemler, zamanında teslimat ve kaliteli işçilik prensibiyle çalışarak,
                müşterilerimizin güvenini kazanmış bir firma olmanın gururunu yaşıyoruz.
              </p>
            </div>
